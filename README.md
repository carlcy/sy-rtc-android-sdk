...
```gradle
dependencies {
    implementation 'com.github.carlcy:sy-rtc-android-sdk:v1.0.2'
}
```

**注意**：将 `carlcy` 替换为你的 GitHub 用户名，`v1.0.2` 替换为实际的版本号。
...
dependencies {
    implementation 'com.sy.rtc:sy-rtc-android-sdk:1.0.2'
}
```
